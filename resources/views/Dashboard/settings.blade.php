...
@section('content')
    <!-- Breadcrumb -->
    <ol class="breadcrumb"  style="margin-top: 5%; margin-right: 15%">
        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{__('words.dashboard')}}</a>
        </li>      
    </ol>
                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <img src="{{asset('images/'.$setting->logo)}}" alt="" style="height: 50px">
                            </div>  

                            <div class="form-group col-md-6">
                                <label>{{ __('words.favicon') }}</label>
                                <img src="{{asset('images/'.$setting->favicon)}}" alt="" style="height: 50px">
                            </div>
                                        ...
                                        <div class="tab-pane mt-3 fade @if ($loop->index == 0) show active in @endif"
                                            ...
                                            <div class="form-group mt-3 col-md-12">
                                                ...
                                                <input type="text" name="{{$key}}[title]" class="form-control"
                                                    placeholder="{{ __('words.title') }}"   value="{{$setting->translate($key)->title}}">
                                            </div>
